...
# |------------------|--------------|------|-------------|
# | Ubuntu 19.04 LTS | OpenCV 4.1.0 | OK   | 14 Apr 2019 |
# |------------------|--------------|------|-------------|
...
# 2. INSTALL THE DEPENDENCIES FOR OPENCV
...
# Video I/O:
sudo apt install -y libdc1394-22-dev libavcodec-dev libavformat-dev libswscale-dev libtheora-dev libvorbis-dev libxvidcore-dev libx264-dev yasm libopencore-amrnb-dev libopencore-amrwb-dev libv4l-dev libxine2-dev freeglut3-dev libglew-dev
...
# 3. INSTALL OPENCV GENERIC LIBRARY
